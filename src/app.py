...
activities = {
    ...
    "Basketball Team": {
        "description": "Basketball practice, scrimmages, and tournaments",
    ...
    "Drama Club": {
        "description": "Theater arts, acting workshops, and school plays",
    ...
    # Intellectual
    "Math Club": {
        "description": "Math competitions, problem-solving, and advanced topics",
